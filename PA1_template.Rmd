...
The time interval with maximum number of steps is `r max_t$interval` (In the morning).
...
The total number of missing values in the dataset are `r t `
...
The mean and mean after imputing the values are `r round(me_imputed)` and `r med_imputed`
